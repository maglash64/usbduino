...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  //HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , 0x82 , PCD_SNG_BUF, 0x108); //in/out 	IF2
...
{
  static uint32_t mem[(sizeof(USBD_DEV_HandleTypeDef)/4)+1];/* On 32-bit boundary */
  return mem;
}
